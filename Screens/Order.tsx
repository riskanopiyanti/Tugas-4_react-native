    ...
    return(
        <View style={styles.container}>
            <ScrollView>
                ...
                <Text style = {{ color: '#2F2D2C', fontWeight: 'bold', fontSize: 16, marginBottom: 5}}> Jl. Merdeka</Text>
                <Text style = {{ color: '#808080', fontWeight: 400, fontSize: 16, marginBottom: 10}}>Situ Gede, Kel. Cipanengah, Kec. Lembursitu, Kota. Sukabumi, Jawa Barat 43168</Text>
